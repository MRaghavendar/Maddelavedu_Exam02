...
namespace Maddelavedu_Exam02.Controllers
{
    public class PlayerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlayerID,LastName,FirstMidName,Age")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlayerID,LastName,FirstMidName,Age")] Player player)
        {
            if (ModelState.IsValid)
            {
